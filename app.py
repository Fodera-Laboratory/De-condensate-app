...
- [Dieing & Hollricher, *Spectroscopy* (2008)](https://www.spectroscopyonline.com/view/basic-aspects-experimental-design-raman-microscopy) — experimental design guidelines for Raman microscopy
    ...
    st.markdown(
        ...
        "| [SciPy](https://scipy.org) | Savitzky-Golay smoothing, ALS baseline, rolling-ball, Gaussian smoothing, FFT low-pass, peak fitting, NNLS (CLS unmixing) | [Virtanen et al., 2020](https://doi.org/10.1038/s41592-019-0686-2) |\n"
        "| Custom | Spike removal (Whitaker-Hayes modified Z-score) | [Whitaker & Hayes, 2018](https://doi.org/10.1016/j.chemolab.2018.06.009) |\n"
        "| Custom | Rubberband (convex hull) baseline correction | — |\n"
        "| Custom | Endpoint / linear baseline; SNV / area / vector normalisation | — |\n"
